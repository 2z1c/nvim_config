...
-- 切换上一个缓冲区
vim.keybinds.gmap("n", "<CTRL-V><CTRL-PAGEUP>", "<cmd>BufferLineCyclePrev<CR>", vim.keybinds.opts)
-- 切换下一个缓冲区
vim.keybinds.gmap("n", "<CTRL-V><CTRL-PAGEDOWN>", "<cmd>BufferLineCycleNext<CR>", vim.keybinds.opts)
-- 关闭左侧缓冲区
